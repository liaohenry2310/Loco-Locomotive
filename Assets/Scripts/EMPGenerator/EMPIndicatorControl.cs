...
public class EMPIndicatorControl : MonoBehaviour
{
    [SerializeField] private EMPGeneratorData _empGeneratorData = null;
    ...
    private void Awake()
    {
        EnergyIndicator = new EnergyIndicator(_empGeneratorData.ChargeTime, _empGeneratorData.CoolDownTime);
